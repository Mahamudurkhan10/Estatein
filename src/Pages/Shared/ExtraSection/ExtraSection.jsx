...
const ExtraSection = () => {
     return (
          <div className="  container mx-auto lg:border-2 text-gray-200  lg:border-base-100 mb-7 mt-9">
              <div
                    ...
                    <div className="lg:max-w-[1400px] lg:mx-auto  ">
                         <div className="flex flex-col lg:flex-row p-3 lg:p-0 lg:justify-between items-center">
                             ...
                             <a href={'/properties'} className={'btn bg-[#703bf7] px-6 mt-4 lg:mt-0   text-white hover:bg-[#572fbd]'}> <button className="">Explore Properties</button></a>
                         </div>
                    </div>
               </div>
          </div>
