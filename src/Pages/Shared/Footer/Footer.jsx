...
const Footer = () => {
     return (
          <div>
                    ...
                    <div >
                         ...
                         <form  action="">
                              <label className="input input-bordered mt-5   flex items-center gap-2">
                                   ...
                                   <button className="text-2xl font-bold  text-blue-500">  <IoIosSend></IoIosSend> </button>
                              </label>
               ...
               <div>
                    <footer className="footer flex lg:flex-row flex-col justify-around items-center bg-[#191919] text-lg text-white container mx-auto  p-4">
