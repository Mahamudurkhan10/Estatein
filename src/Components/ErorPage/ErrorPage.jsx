...
export default function ErrorPage() {
  return (
    <div>
      <section class="relative z-10 bg-[#191919] h-screen py-[200px]">
            ...
            <div class="w-full px-4">
              <div class="mx-auto max-w-[400px] text-center">
                ...
                <Link to={'/'}
                  ...
                  class="inline-block btn animate-bounce hover:bg-[#703bf7] hover:animate-pulse  rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition  hover:text-white"
                >
                  Go To Home
                </Link>
              </div>
